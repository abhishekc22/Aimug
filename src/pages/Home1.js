                  ...
                  <div className="feature-one__main-content-box">
                    ...
                    <div className="feature-one__main-content-middle">
                      <div className="feature-one__start-1 zoominout">
                        <img
                          src="images/shapes/feature-one-star-1.png"
                          alt=""
                        />
                      </div>
                      <div className="feature-one__start-2 float-bob-x">
                        <img
                          src="images/shapes/feature-one-star-2.png"
                          alt=""
                        />
                      </div>
                      ...
                      <div className="feature-one__start-6 float-bob-x">
                        <img
                          src="images/shapes/feature-one-star-6.png"
                          alt=""
                        />
                      </div>
                      <div className="feature-one__start-7 float-bob-y">
                        <img
                          src="images/shapes/feature-one-star-7.png"
                          alt=""
                        />
                      </div>
                      ...
                      <div className="solutions-two__content-one-left">
                        ...
                        <ul className="solutions-two__content-one-points">
                          <li>
                            ...
                            <div className="text">
                              <p>
                                There are more than <span>60+</span> use cases
                                and templates to pick from to meet all of your
                                writing demands.
                              </p>
                            </div>
                          </li>
                          ...
                          <li>
                            ...
                            <div className="text">
                              <p>
                                Choose the best AI copy for your message & save
                                as a document
                              </p>
                            </div>
                          </li>
                    ...
                    >
                      <div className="solutions-two__content-two-single solutions-two__content-two-single-2">
                        <div className="solutions-two__content-two-top">
                          ...
                          <p className="solutions-two__content-two-text-1">
                            By listening to our leading AI text to speech
                            reader, you can breeze through papers, articles,
                            PDFs, and emails.
                          </p>
                          <div className="solutions-two__content-two-btn">
                            <a href="about.html">
                    ...
                    <div className="col-xl-6">
                      <div className="solutions-two__content-three-right">
                        ...
                        <p className="solutions-two__content-three-text-1">
                          ...
                          photographs in seconds. Finally, you'll have the
                          perfect image to go with your statement.
                        </p>
                    ...
                    <div className="testimonial-one__single">
                      <div className="testimonial-one__client-info">
                        <div className="testimonial-one__client-img">
                          <img
                            src="images/resource/testimonial-1-1.jpg"
                            alt=""
                          />
                        </div>
                  ...
                  <div className="col-xl-3 col-lg-6 col-md-6">
                    <div className="testimonial-one__single">
                      <div className="testimonial-one__client-info">
                        <div className="testimonial-one__client-img">
                          <img
                            src="images/resource/testimonial-1-2.jpg"
                            alt=""
                          />
                        </div>
                        <div className="testimonial-one__name-box">
                  ...
                  <div className="col-xl-3 col-lg-6 col-md-6">
                    <div className="testimonial-one__single">
                      <div className="testimonial-one__client-info">
                        <div className="testimonial-one__client-img">
                          <img
                            src="images/resource/testimonial-1-3.jpg"
                            alt=""
                          />
                        </div>
                        <div className="testimonial-one__name-box">
                  ...
                  <div className="col-xl-3 col-lg-6 col-md-6">
                    <div className="testimonial-one__single">
                      <div className="testimonial-one__client-info">
                        <div className="testimonial-one__client-img">
                          <img
                            src="images/resource/testimonial-1-4.jpg"
                            alt=""
                          />
                        </div>
                        <div className="testimonial-one__name-box">
                  ...
                  <div className="col-xl-3 col-lg-6 col-md-6">
                    <div className="testimonial-one__single testimonial-one__single-5">
                      <div className="testimonial-one__client-info">
                        <div className="testimonial-one__client-img">
                          <img
                            src="images/resource/testimonial-1-5.jpg"
                            alt=""
                          />
                        </div>
                        <div className="testimonial-one__name-box">
                      ...
                      <p className="testimonial-one__text">
                        Awesome Template as well as great customer support
                        within few minutes. Recommended. Best Complete AI Tools
                        ever I have used. Great Design and High Quality Code.
                      </p>
                      <div className="testimonial-one__icon-and-ratting">
                        <div className="testimonial-one__icon">
                          <img
                  ...
                  <div className="col-xl-3 col-lg-6 col-md-6">
                    <div className="testimonial-one__single testimonial-one__single-6">
                      <div className="testimonial-one__client-info">
                        <div className="testimonial-one__client-img">
                          <img
                            src="images/resource/testimonial-1-6.jpg"
                            alt=""
                          />
                        </div>
                        <div className="testimonial-one__name-box">
                      ...
                      <p className="testimonial-one__text">
                        Awesome Template as well as great customer support
                        within few minutes. Recommended. Best Complete AI Tools
                        ever I have used. Thanks marveltheme for this type of
                        awesome tools.{" "}
                      </p>
                      <div className="testimonial-one__icon-and-ratting">
                        <div className="testimonial-one__icon">
                  ...
                  <div className="col-xl-3 col-lg-6 col-md-6">
                    <div className="testimonial-one__single testimonial-one__single-7">
                      <div className="testimonial-one__client-info">
                        <div className="testimonial-one__client-img">
                          <img
                            src="images/resource/testimonial-1-7.jpg"
                            alt=""
                          />
                        </div>
                        <div className="testimonial-one__name-box">
                      ...
                      <p className="testimonial-one__text">
                        Great Design and High Quality Code. This is best
                        Complete template AI Tools ever I have used. Thanks
                        marveltheme!
                      </p>
                      <div className="testimonial-one__icon-and-ratting">
                        <div className="testimonial-one__icon">
                  ...
                  <div className="col-xl-3 col-lg-6 col-md-6">
                    <div className="testimonial-one__single testimonial-one__single-8">
                      <div className="testimonial-one__client-info">
                        <div className="testimonial-one__client-img">
                          <img
                            src="images/resource/testimonial-1-8.jpg"
                            alt=""
                          />
                        </div>
                        <div className="testimonial-one__name-box">
                  ...
                  <div className="col-xl-3 col-lg-6 col-md-6">
                    <div className="testimonial-one__single testimonial-one__single-9">
                      <div className="testimonial-one__client-info">
                        <div className="testimonial-one__client-img">
                          <img
                            src="images/resource/testimonial-1-9.jpg"
                            alt=""
                          />
                        </div>
                        <div className="testimonial-one__name-box">
                      ...
                      <div className="accrodion-content">
                        <div className="inner">
                          <p>
                            ...
                            <a href="#">choose a topic</a> that will resonate
                            with them. Look for trending topics in your industry
                            or address common questions or challenges your
                            audience may be facing. Keep in mind that your topic
                            should be both interesting and relevant to your
                            audience
                          </p>
                        </div>
                      </div>
                    ...
                    >
                      <div className="footer-widget__column footer-widget__about">
                        <div className="footer-widget__logo">
                          <a href="index.html">
                            <img
                              src="images/resource/footer-logo-1.png"
                              alt=""
                            />
                          </a>
                        </div>
