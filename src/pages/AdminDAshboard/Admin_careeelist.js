            ...
            <ul className="nxl-navbar">
              ...
              <li className="nxl-item nxl-hasmenu">
                ...
                <ul className="nxl-submenu">
                  ...
                  <Link to="/carrirer_list" className="nxl-link">  carrer list</Link>               
                  </li>
                  <li className="nxl-item">
              ...
              <li className="nxl-item nxl-hasmenu">
                ...
                <ul className="nxl-submenu">
                  <li className="nxl-item">
                    <a className="nxl-link" href="apps-chat.html">
                      Chat
                    </a>
                  </li>
                  <li className="nxl-item">
                    <a className="nxl-link" href="apps-email.html">
                      Email
                    </a>
                  </li>
                  <li className="nxl-item">
                    <a className="nxl-link" href="apps-tasks.html">
                      Tasks
                    </a>
                  </li>
                  <li className="nxl-item">
                    <a className="nxl-link" href="apps-notes.html">
                      Notes
                    </a>
                  </li>
                  <li className="nxl-item">
                    <a className="nxl-link" href="apps-storage.html">
                      Storage
                    </a>
                  </li>
                  <li className="nxl-item">
                    <a className="nxl-link" href="apps-calendar.html">
                      Calendar
                    </a>
                  </li>
                </ul>
                ...
                <ul className="nxl-submenu">
                  <li className="nxl-item nxl-hasmenu">
                    ...
                    <ul className="nxl-submenu">
                      ...
                      <li className="nxl-item">
                        <a className="nxl-link" href="auth-login-minimal.html">
                          Minimal
                        </a>
                      </li>
                      <li className="nxl-item">
                        <a className="nxl-link" href="auth-login-creative.html">
                          Creative
                        </a>
                      </li>
                    </ul>
                  ...
                  <li className="nxl-item nxl-hasmenu">
                    ...
                    <ul className="nxl-submenu">
                      <li className="nxl-item">
                        <a className="nxl-link" href="auth-register-cover.html">
                          Cover
                        </a>
                      </li>
                      <li className="nxl-item">
                  ...
                  <li className="nxl-item nxl-hasmenu">
                    ...
                    <ul className="nxl-submenu">
                      ...
                      <li className="nxl-item">
                        <a className="nxl-link" href="auth-reset-minimal.html">
                          Minimal
                        </a>
                      </li>
                      <li className="nxl-item">
                        <a className="nxl-link" href="auth-reset-creative.html">
                          Creative
                        </a>
                      </li>
                    </ul>
                  ...
                  <li className="nxl-item nxl-hasmenu">
                    ...
                    <ul className="nxl-submenu">
                      ...
                      <li className="nxl-item">
                        <a className="nxl-link" href="auth-verify-minimal.html">
                          Minimal
                        </a>
                      </li>
                      <li className="nxl-item">
              ...
              <li className="nxl-item nxl-hasmenu">
                ...
                <ul className="nxl-submenu">
                  <li className="nxl-item">
                    <a
                      className="nxl-link"
                      href="https://themeforest.net/user/theme_ocean/"
                    >
                      Support
                    </a>
                  </li>
                  ...
                  <li className="nxl-item">
                    <a className="nxl-link" href=".docs/documentations.html">
                      Documentations
                    </a>
                  </li>
                </ul>
            ...
            >
              ...
              <div className="content-sidebar-header">
                ...
                >
                  ...
                  <span><Link to="/Add_job" >Add Carrer</Link></span>             
                </a>
              </div>
              <div className="content-sidebar-body">
                <ul className="nav d-flex flex-column nxl-content-sidebar-item">
                  <li className="nav-item">
                    <a
                      href="javascript:void(0)"
                      className="nav-link note-link active"
                      id="all-category"
                    >
                      <i className="feather-layers"></i>
                      <span>Alls</span>
            ...
            >
              ...
              <div className="content-area-body pb-0">
                <div className="row note-has-grid" id="note-full-container">
                  <div className="col-xxl-4 col-xl-6 col-lg-4 col-sm-6 single-note-item all-category note-important note-tasks">
                    <div className="card card-body mb-4 stretch stretch-full">
                      ...
                      <div className="note-content flex-grow-1">
                        <p
                          className="text-muted note-inner-content text-truncate-3-line"
                        ...
                        >
                          ...
                          elit. Facilis vitae iure, quo harum excepturi
                          laudantium eum earum accusantium labore libero maiores
                          illo soluta.
                        </p>
                      </div>
                      <div className="d-flex align-items-center gap-1">
                        ...
                        <span className="avatar-text avatar-sm">
                          <i className="feather-trash-2 remove-note"></i>
                        </span>
                        <div className="ms-auto">
                          <div className="dropdown btn-group category-selector">
                            ...
                            <div className="dropdown-menu dropdown-menu-right category-menu">
                              <a
                                className="note-tasks badge-group-item badge-tasks dropdown-item position-relative category-tasks"
                                href="javascript:void(0);"
                              >
                                <span className="wd-5 ht-5 bg-danger rounded-circle me-3"></span>
                                Tasks{" "}
                              </a>
                              <a
                                className="note-works badge-group-item badge-works dropdown-item position-relative category-works"
                                href="javascript:void(0);"
                              >
                                <span className="wd-5 ht-5 bg-primary rounded-circle me-3"></span>
                                Works{" "}
                              </a>
                              <a
                                className="note-social badge-group-item badge-social dropdown-item position-relative category-social"
                                href="javascript:void(0);"
                              >
                                <span className="wd-5 ht-5 bg-info rounded-circle me-3"></span>
                                Social{" "}
                              </a>
                              <a
                                className="note-archive badge-group-item badge-archive dropdown-item position-relative category-archive"
                                href="javascript:void(0);"
                              >
                                <span className="wd-5 ht-5 bg-dark rounded-circle me-3"></span>
                                Archive{" "}
                              </a>
                              <a
                                className="note-priority badge-group-item badge-priority dropdown-item position-relative category-priority"
                                href="javascript:void(0);"
                              >
                                <span className="wd-5 ht-5 bg-danger rounded-circle me-3"></span>
                                Priority{" "}
                              ...
                              <a
                                className="note-personal badge-group-item badge-personal dropdown-item position-relative category-personal"
                                href="javascript:void(0);"
                              >
                                <span className="wd-5 ht-5 bg-primary rounded-circle me-3"></span>
                                Personal{" "}
                              ...
                              <a
                                className="note-business badge-group-item badge-business dropdown-item position-relative category-business"
                                href="javascript:void(0);"
                              >
                                <span className="wd-5 ht-5 bg-warning rounded-circle me-3"></span>
                                Business{" "}
                              </a>
                              <a
                                className="note-important badge-group-item badge-important dropdown-item position-relative category-important"
                                href="javascript:void(0);"
                              >
                                <span className="wd-5 ht-5 bg-success rounded-circle me-3"></span>
                                Important{" "}
                              </a>
                            </div>
                          </div>
                  ...
                  <div className="col-xxl-4 col-xl-6 col-lg-4 col-sm-6 single-note-item all-category note-important note-archive note-works">
                    <div className="card card-body mb-4 stretch stretch-full">
                      <span className="side-stick"></span>
                      <h5
                        className="note-title text-truncate w-75 mb-1"
                  ...
                  <div className="col-xxl-4 col-xl-6 col-lg-4 col-sm-6 single-note-item all-category note-important note-works">
                    <div className="card card-body mb-4 stretch stretch-full">
                      <span className="side-stick"></span>
                      <h5
                        className="note-title text-truncate w-75 mb-1"
                  ...
                  <div className="col-xxl-4 col-xl-6 col-lg-4 col-sm-6 single-note-item all-category note-business note-priority">
                    <div className="card card-body mb-4 stretch stretch-full">
                      <span className="side-stick"></span>
                      <h5
                        className="note-title text-truncate w-75 mb-1"
